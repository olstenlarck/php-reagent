...
--
-- Table structure for table `reagent_about`
--

CREATE TABLE IF NOT EXISTS `reagent_about` (
  `abText` text NOT NULL,
  `abDate` varchar(100) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `reagent_about`
--

INSERT INTO `reagent_about` (`abText`, `abDate`) VALUES
...
--
-- Table structure for table `reagent_config`
--

CREATE TABLE IF NOT EXISTS `reagent_config` (
...
--
-- Dumping data for table `reagent_config`
--

INSERT INTO `reagent_config` (`sys_temp_id`, `sys_temp_name`, `sys_default_temp`) VALUES
(1, 'Envision', 'default'),
(2, 'smartFTP', '');
...
--
-- Table structure for table `reagent_news`
--

CREATE TABLE IF NOT EXISTS `reagent_news` (
...
--
-- Dumping data for table `reagent_news`
--

INSERT INTO `reagent_news` (`newID`, `newName`, `newAuthor`, `newDate`, `newText`) VALUES
...
--
-- Table structure for table `reagent_users`
--

CREATE TABLE IF NOT EXISTS `reagent_users` (
...
--
-- Dumping data for table `reagent_users`
--

INSERT INTO `reagent_users` (`userID`, `userName`, `userPass`, `userEmail`, `userRegDate`, `userIP`, `userGroup`) VALUES
